...
| Compras | Recepcion de productos | Admin | Registrar recepción parcial/completa, corregir flete, pesos, trackings y sobrantes | Orden, productos recibidos, cantidades, pesos, trackings y flete | `POST /api/v1/orders/{orderId}/receipts`, `PATCH /api/v1/orders/{orderId}/receipts/{receiptId}` |
